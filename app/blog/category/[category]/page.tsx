...
const getSubcategoryData = (categorySlug: string) => {
  const subcategories: Record<string, any> = {
    "web-development": {
      name: "Web Development",
      description: "Explore our collection of tutorials and insights on modern web development technologies",
      image: "https://images.unsplash.com/photo-1555066931-4365d14bab8c?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2070&q=80",
      subcategories: [
        { name: "Frontend Development", slug: "frontend", count: 45 },
        { name: "Backend Development", slug: "backend", count: 38 },
        { name: "Full-Stack Development", slug: "full-stack", count: 22 },
        { name: "API Development", slug: "api", count: 15 },
    ...
    "programming": {
      ...
      subcategories: [
        { name: "JavaScript", slug: "javascript", count: 32 },
        { name: "Python", slug: "python", count: 28 },
        { name: "Java", slug: "java", count: 18 },
        { name: "C++", slug: "cpp", count: 12 },
    ...
    "design": {
      ...
      subcategories: [
        { name: "UI Design", slug: "ui-design", count: 25 },
        { name: "UX Research", slug: "ux-research", count: 22 },
        { name: "Graphic Design", slug: "graphic-design", count: 18 },
        { name: "Motion Design", slug: "motion-design", count: 12 },
        { name: "Design Systems", slug: "design-systems", count: 10 }
      ]
    },
    "mobile": {
      name: "Mobile",
      ...
      subcategories: [
        { name: "iOS Development", slug: "ios", count: 24 },
        { name: "Android Development", slug: "android", count: 22 },
        { name: "React Native", slug: "react-native", count: 12 },
        { name: "Flutter", slug: "flutter", count: 8 },
        { name: "Mobile UX", slug: "mobile-ux", count: 8 }
      ]
    },
    "seo-marketing": {
      name: "SEO & Marketing",
      ...
      subcategories: [
        { name: "SEO Optimization", slug: "seo", count: 20 },
        { name: "Content Marketing", slug: "content-marketing", count: 15 },
        { name: "Social Media", slug: "social-media", count: 10 },
        { name: "Email Marketing", slug: "email-marketing", count: 5 },
    ...
    "content-creation": {
      ...
      subcategories: [
        { name: "Writing Tips", slug: "writing", count: 18 },
        { name: "Video Content", slug: "video", count: 12 },
        { name: "Podcasting", slug: "podcasting", count: 8 },
        { name: "Visual Content", slug: "visual-content", count: 5 }
      ]
    }
  };

  return subcategories[categorySlug] || subcategories["web-development"];
};
...
export default function CategoryPage({ params }: { params: { category: string } }) {
  ...
  const categoryData = getSubcategoryData(params.category);
  
  const categories = ["All", ...categoryData.subcategories.map((sub: any) => sub.name)];
  const sortOptions = [
  ...
  const filteredPosts = posts.filter(post => {
    ...
    // For demo purposes, we'll show all posts in each category
  ...
  return (
    <div className="pt-32 pb-20">
      ...
      <section className="container mx-auto px-6 mb-16">
        ...
        >
          ...
          <h1 className="text-5xl md:text-7xl font-display font-bold mb-6">
            {categoryData.name} <span className="bg-gradient-to-r from-blue-500 to-purple-600 bg-clip-text text-transparent">Articles</span>
          </h1>
      ...
      {/* Subcategories */}
      <section className="container mx-auto px-6 mb-16">
        <h2 className="text-3xl font-display font-bold mb-8">Subcategories</h2>
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4">
          {categoryData.subcategories.map((subcat: any, index: number) => (
            <motion.div
              key={index}
              ...
              whileHover={{ y: -5 }}
              className="glass p-4 rounded-xl text-center cursor-pointer hover:bg-white/10 transition-all"
            >
              <h3 className="font-semibold mb-1">{subcat.name}</h3>
              <p className="text-sm text-muted-foreground">{subcat.count} articles</p>
            </motion.div>
          ))}
        </div>
      </section>
      ...
      <section className="container mx-auto px-6 mt-32">
        ...
        >
          <h2 className="text-4xl font-display font-bold mb-4">
            Stay Updated on {categoryData.name}
          </h2>
          <p className="text-muted-foreground mb-8">
            Get the latest articles and insights in {categoryData.name} delivered to your inbox every week
          </p>
